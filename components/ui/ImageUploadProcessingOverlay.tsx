...
interface ImageUploadProcessingOverlayProps {
  visible: boolean;
  message?: string;
}

export const ImageUploadProcessingOverlay: React.FC<ImageUploadProcessingOverlayProps> = ({
  visible,
  message = 'Uploading image Please wait for a while',
}) => {
